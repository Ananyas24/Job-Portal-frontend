    ...
    return (
        <div className='max-w-7xl mx-auto my-10'>
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        <Badge className={'text-blue-700 font-bold'} variant="ghost">4 Positions</Badge>
                        <Badge className={'text-[#F83002] font-bold'} variant="ghost">full Time</Badge>
                        <Badge className={'text-[#7209b7] font-bold'} variant="ghost">7-10 LPA</Badge>
                    </div>
                </div>
                <Button
            ...
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1'>Description: <span className='pl-4 font-normal text-gray-800'>ahxuishnmsnjkq</span></h1>
                <h1 className='font-bold my-1'>Experience: <span className='pl-4 font-normal text-gray-800'>2 yrs</span></h1>
                <h1 className='font-bold my-1'>Salary: <span className='pl-4 font-normal text-gray-800'>7-10 LPA</span></h1>
